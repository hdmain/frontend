...
const en: Dictionary = {
  ...
  protection: {
    eyebrow: "PletX protection network",
    title: "PletX DDoS filtering",
    lead: "Stateful DDoS protection from PletX GmbH, built for game servers and applications, with custom filtering deployed in hours.",
    card1Title: "PletX & edge scrubbing",
    card1Body:
      "PletX runs mitigation at exchange points in Warsaw, Amsterdam and Frankfurt (Digital Realty FRA 7), with custom solutions and GRE tunnels for your own traffic.",
    stat1Value: "10+ Tbps",
...
const pl: Dictionary = {
  ...
  protection: {
    eyebrow: "Sieć ochrony PletX",
    title: "Filtrowanie DDoS PletX",
    lead: "Stateful ochrona DDoS od PletX GmbH, zbudowana pod serwery gier i aplikacje, z niestandardowymi filtrami wdrażanymi w kilka godzin.",
    card1Title: "PletX i edge scrubbing",
    card1Body:
      "PletX filtruje ruch na punktach wymiany w Warszawie, Amsterdamie i Frankfurcie (Digital Realty FRA 7), z custom rozwiązaniami i tunelami GRE dla Twojego ruchu.",
    stat1Value: "10+ Tbps",
...
const ru: Dictionary = {
  ...
  protection: {
    eyebrow: "Сеть защиты PletX",
    title: "Фильтрация DDoS PletX",
    lead: "Stateful защита от DDoS от PletX GmbH для игровых серверов и приложений, с кастомными фильтрами, которые разворачиваются за часы.",
    card1Title: "PletX и edge scrubbing",
    card1Body:
      "PletX фильтрует трафик на точка обмена в Варшаве, Амстердаме и Франкфурте (Digital Realty FRA 7), с кастомными решениями и GRE-туннелями.",
    stat1Value: "10+ Tbps",
