...
const en: Dictionary = {
  ...
  protection: {
    eyebrow: "Plattx protection network",
    title: "Plattx DDoS filtering",
    lead: "Multi-layer DDoS mitigation on the Plattx network, designed for game traffic and scrubbing volumetric noise before it reaches your node.",
    card1Title: "Plattx & edge scrubbing",
    card1Body:
      "Volumetric attack traffic is filtered directly in our Warsaw data centre so your services stay responsive under attack.",
    stat1Value: "10+ Tbps",
...
const pl: Dictionary = {
  ...
  protection: {
    eyebrow: "Sieć ochrony Plattx",
    title: "Filtrowanie DDoS Plattx",
    lead: "Wielowarstwowa mitygacja DDoS w sieci Plattx pod ruch gier, oczyszcza wolumetryczny śmieć zanim dotrze do Twojego węzła.",
    card1Title: "Plattx i edge scrubbing",
    card1Body:
      "Ruch atakowy filtrujemy bezpośrednio w naszym centrum danych w Warszawie, dzięki czemu usługi zostają responsywne pod atakiem.",
    stat1Value: "10+ Tbps",
...
const ru: Dictionary = {
  ...
  protection: {
    eyebrow: "Сеть защиты Plattx",
    title: "Фильтрация DDoS Plattx",
    lead: "Многоуровневая защита от DDoS в сети Plattx для игрового трафика, отсекает объёмный мусор до вашей ноды.",
    card1Title: "Plattx и edge scrubbing",
    card1Body:
      "Атакующий трафик фильтруется прямо в нашем дата-центре в Варшаве, чтобы сервисы оставались отзывчивыми под атакой.",
    stat1Value: "10+ Tbps",
